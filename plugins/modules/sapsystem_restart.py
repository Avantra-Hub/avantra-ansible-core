...
def run_module():
    ...
    argument_spec.update({
        ...
        "soft_timeout": dict(type='int', required=False, default=0),
        "send_user_info": dict(type='bool', required=False, default=False),
        "force_stop": dict(type='bool', required=False, default=True),
        "check_db_state": dict(type='bool', required=False, default=True),
        "restart_wait_seconds": dict(type='int', required=False, default=5),
    })
    ...
    result["action_result"] = module.execute_system_action(
        ...
        args={
            "SOFTTIMEOUT": module.params["soft_timeout"],
            "SEND_USER_INFO": module.params["send_user_info"],
            ...
            "RESTART_WAIT_SECONDS": module.params["restart_wait_seconds"]
        }
    )
